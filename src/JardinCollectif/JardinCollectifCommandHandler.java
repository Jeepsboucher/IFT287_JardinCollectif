...
public class JardinCollectifCommandHandler extends CommandHandler {
  ...
  protected JardinCollectifCommandHandler(Connection connection)
      throws ClassNotFoundException, IFT287Exception {
  ...
  public void requestToJoinLot(String lotName, long memberId) throws IFT287Exception {
  ...
  public void displayMembers() throws IFT287Exception {
  ...
  public void displayLots() throws IFT287Exception {
  ...
  public void displayPlants() throws IFT287Exception {
    List<Plant> plants = plantTransactions.getPlants();
    for (Plant plant : plants) {
      long quantitySowed = plantTransactions.getQuantitySowed(plant.plantName);
      System.out.println("Name : " + plant.plantName + " Quantity sowed : " + quantitySowed);
    }
  }

  @Command("afficherPlantesLot")
  public void displayPlantsInLot(String lotName) throws IFT287Exception {
